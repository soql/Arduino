...
{
  /* Index 0 */ KnxComObject(G_ADDR(8,0,7), KNX_DPT_1_001 /* 1.001 B1 DPT_Switch */ , COM_OBJ_SENSOR  /* Sensor Output */ ) ,
  /* Index 1 */ KnxComObject(G_ADDR(8,0,15), KNX_DPT_1_001 /* 1.001 B1 DPT_Switch */ , COM_OBJ_LOGIC_IN_INIT /* Logical Input Object with Init Read */) , 
};
...
void setup(){
  ...
  Knx.begin(Serial, P_ADDR(1,1,90)); // start a KnxDevice session with physical address 1.1.1 on Serial UART
}
